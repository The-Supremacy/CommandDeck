...
namespace CommandDeck.Host.Configuration;

public static class HostAuthenticationConfiguration
{
    public const string CookieScheme = "CommandDeck.Session";
...
public sealed class HostAuthenticationOptions
{
    ...
    public string CookieName { get; init; } = "CommandDeck.Session";
    ...
    public string SessionTicketCacheInstanceName { get; init; } = "CommandDeck.SessionTickets:";
...
{
    public string Authority { get; init; } = "http://localhost:8080/realms/commanddeck";

    public string ClientId { get; init; } = "commanddeck-host";
